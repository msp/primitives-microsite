...
AVUgenThree.prototype.modalData = function() {
  body = "<i class=\"big quote left icon\"></i>";
  ...
  body += "<p class=\"danni-signature\">Danni Zuvela, 2014</p>";

  body += "<div class=\"pr\"><p>'Primitives' was born when <a href=\"http://spatial.infrasonics.net\">Spatial</a> devised a performative installation of light and sound by coding his own software, exploring the OpenFrameworks platform. ";
  ...
  body += "The logical next step is to release it to the wider world in some shape – the work itself, Spatial’s software that created it and the underlying code to hack the project. But how does a producer and DJ release these related strands into a coherent package that envelops the project’s handmade, atavistic blossoming, both visual and aural? How could that blend with his prior output? And fundamentally, who would be mad enough to pull it all together? Step forward <a href=\"http://www.broken20.com\">Broken20</a>, the Glasgow label founded on \"an aesthetic, not a genre – releases concerned with decay, erosion, entropy, mistakes and errors, line noise and tape hiss, hum and buzz\". And as Broken20’s first foray into vinyl following a multi-format splurge of tapes, DVDs and custom made USB sticks it made sense to collaborate on a 12\" that was more than just a slab of wax. </p>";

  body += "<p>So we have ‘Primitives’, a <a href=\"http://store.broken20.com/album/spatial-primitives\">DVD</a> containing short films of live A/V content alongside an <a href=\"http://store.broken20.com/album/spatial-primitives\">executable version</a> of the software and the <a href=\"https://github.com/msp/mspUgen\">source code</a> plus a <a href=\"http://store.broken20.com/album/spatial-primitives\">12” record</a> containing four commissioned interpretations by Spatial himself, Broken20’s <a href=\"http://ruaridhtvo.tumblr.com\">TVO</a>, <a href=\"http://magicanddreams.wordpress.com\">Bass Clef</a> and <a href=\"http://tapebox.co.uk\">Sculpture</a> aimed somewhat more at the dancefloor. The combination of media represent the totality of the ‘Primitives’ experience. The DVD contains a series of live, improvised audiovisual art works under two distinct sections: Single Channel & Expanded. </p>";
